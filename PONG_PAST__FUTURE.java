...
public class PONG_PAST__FUTURE extends PApplet {
...
//GAME OVER
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--stop-color=#cccccc", "PONG_PAST__FUTURE" };
    if (passedArgs != null) {
